...
def test_error_1():
    assert "Error" in main(open(Path(__file__ + "/../" + "files/test_error_1").absolute()), False)


def test_error_2():
    assert "Error" in main(open(Path(__file__ + "/../" + "files/test_error_2").absolute()), False)


def test_error_3():
    assert "Error" in main(open(Path(__file__ + "/../" + "files/test_error_3").absolute()), False)


def test_error_4():
    assert "Error" in main(open(Path(__file__ + "/../" + "files/test_error_4").absolute()), False)


def test_error_5():
    assert "Error" in main(open(Path(__file__ + "/../" + "files/test_error_5").absolute()), False)


def test_error_6():
    assert "Error" in main(open(Path(__file__ + "/../" + "files/test_error_6").absolute()), False)


def test_error_7():
    assert "Error" in main(open(Path(__file__ + "/../" + "files/test_error_7").absolute()), False)


def test_error_8():
    assert "Error" in main(open(Path(__file__ + "/../" + "files/test_error_8").absolute()), False)


def test_error_9():
    assert "Error" in main(open(Path(__file__ + "/../" + "files/test_error_9").absolute()), False)


def test_error_10():
    assert "Error" in main(open(Path(__file__ + "/../" + "files/test_error_10").absolute()), False)


def test_error_11():
    assert "Error" in main(open(Path(__file__ + "/../" + "files/test_error_11").absolute()), False)


def test_error_12():
    assert "Error" in main(open(Path(__file__ + "/../" + "files/test_error_12").absolute()), False)


def test_error_13():
    assert "Error" in main(open(Path(__file__ + "/../" + "files/test_error_13").absolute()), False)


def test_error_14():
    assert "Error" in main(open(Path(__file__ + "/../" + "files/test_error_14").absolute()), False)


def test_error_15():
    assert "Error" in main(open(Path(__file__ + "/../" + "files/test_error_15").absolute()), False)


def test_error_16():
    assert "Error" in main(open(Path(__file__ + "/../" + "files/test_error_16").absolute()), False)


def test_error_17():
    assert "Error" in main(open(Path(__file__ + "/../" + "files/test_error_17").absolute()), False)


def test_error_18():
    assert "Error" in main(open(Path(__file__ + "/../" + "files/test_error_18").absolute()), False)


def test_error_19():
    assert "Error" in main(open(Path(__file__ + "/../" + "files/test_error_19").absolute()), False)


def test_error_20():
    assert "Error" in main(open(Path(__file__ + "/../" + "files/test_error_20").absolute()), False)


def test_error_21():
    assert "Error" in main(open(Path(__file__ + "/../" + "files/test_error_21").absolute()), False)


def test_error_22():
    assert "Error" in main(open(Path(__file__ + "/../" + "files/test_error_22").absolute()), False)


def test_error_23():
    assert "Error" in main(open(Path(__file__ + "/../" + "files/test_error_23").absolute()), False)


def test_error_24():
    assert "Error" in main(open(Path(__file__ + "/../" + "files/test_error_24").absolute()), False)


def test_error_25():
    assert "Error" in main(open(Path(__file__ + "/../" + "files/test_error_25").absolute()), False)


def test_error_26():
    assert "Error" in main(open(Path(__file__ + "/../" + "files/test_error_26").absolute()), False)


def test_error_27():
    assert "Error" in main(open(Path(__file__ + "/../" + "files/test_error_27").absolute()), False)


def test_error_28():
    assert "Error" in main(open(Path(__file__ + "/../" + "files/test_error_28").absolute()), False)


def test_error_29():
    assert "Error" in main(open(Path(__file__ + "/../" + "files/test_error_29").absolute()), False)


def test_error_30():
    assert "Error" in main(open(Path(__file__ + "/../" + "files/test_error_30").absolute()), False)


def test_error_31():
    assert "Error" in main(open(Path(__file__ + "/../" + "files/test_error_31").absolute()), False)


def test_error_32():
    assert "Error" in main(open(Path(__file__ + "/../" + "files/test_error_32").absolute()), False)


def test_error_33():
    assert "Error" in main(open(Path(__file__ + "/../" + "files/test_error_33").absolute()), False)
