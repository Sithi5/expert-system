...
if __name__ == "__main__":
	...
	###Trust_table TRYOUT
	truth_table.find_operand_value(tree.letters["A"].expression_parents[0]
							,tree.letters["A"].expression_parents[0].children[0],
							tree.letters["A"].expression_parents[0].children[1])
	truth_table.find_operand_value(tree.letters["D"].expression_parents[0]
							,tree.letters["D"].expression_parents[0].children[0],
							tree.letters["D"].expression_parents[0].children[1])
	truth_table.find_operand_value(tree.letters["G"].expression_parents[0]
